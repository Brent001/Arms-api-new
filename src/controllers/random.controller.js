...
export const getRandom = async (req, res) => {
  try {
    const animeData = await extractRandom();

    // Fetch seasons and most popular animes in parallel
    const [seasons, mostPopularAnimes] = await Promise.all([
      extractSeasons(animeData.id),
